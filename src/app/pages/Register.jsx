...
import { Mail, Phone, Lock, Eye, EyeOff, Hotel, User, Globe, Check, X } from "lucide-react";
      ...
      <div className="hidden lg:flex relative bg-gradient-to-br from-[#0071C2] to-[#003580] items-center justify-center p-12">
        ...
        <div className="relative z-10 text-white max-w-md">
          <Link to="/" className="flex items-center gap-3 mb-8">
            ...
            <span className="text-3xl font-bold">StayEase</span>
          </Link>
          <h2 className="text-4xl font-bold mb-4">{t('auth.register.title')}</h2>
      ...
      <div className="flex items-center justify-center p-8 bg-background overflow-y-auto">
        ...
        >
          ...
          <Link to="/" className="flex lg:hidden items-center gap-2 mb-8">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#003580] to-[#0071C2] flex items-center justify-center">
              <Hotel className="w-6 h-6 text-white" />
            </div>
            <span className="text-2xl font-bold text-[#003580]">StayEase</span>
          </Link>

          <h1 className="text-3xl font-bold text-[#0F172A] mb-2">{t('auth.register.title')}</h1>
                  ...
                  {formData.password && (
                    <div className="mt-2">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs font-semibold" style={{ color: strengthColors[passwordStrength - 1] || strengthColors[0] }}>
                          {strengthLabels[passwordStrength - 1] || strengthLabels[0]}
                        </span>
                      </div>
                      <div className="space-y-1">
                        <div className={`flex items-center gap-2 text-xs ${formData.password.length >= 8 ? 'text-[#22C55E]' : 'text-[#64748B]'}`}>
                          {formData.password.length >= 8 ? <Check className="w-3 h-3" /> : <X className="w-3 h-3" />}
                          At least 8 characters
                        </div>
                        <div className={`flex items-center gap-2 text-xs ${/[A-Z]/.test(formData.password) && /[a-z]/.test(formData.password) ? 'text-[#22C55E]' : 'text-[#64748B]'}`}>
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="000000"
                  />
                  <button type="button" className="mt-2 text-sm text-[#0071C2] hover:underline font-semibold">
                    Send OTP
                  </button>
                </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-background text-[#64748B]">Or continue with</span>
            </div>
          </div>
          ...
          <p className="text-center text-sm text-[#64748B]">
            ...
            <Link to="/signin" className="text-[#0071C2] font-semibold hover:underline">
