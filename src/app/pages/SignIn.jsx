      ...
      <div className="flex items-center justify-center p-8 bg-background">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {loginMethod === "email" ? (
              <>
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-sm text-[#64748B]">{t('auth.signIn.rememberMe')}</span>
                  </label>
                  <Link to="#" className="text-sm text-[#0071C2] hover:underline font-semibold">
              ...
              <>
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#0F172A] mb-2">
                    {t('auth.register.phonePlaceholder').split(' ')[0]} {t('auth.register.phonePlaceholder').split(' ')[1]}
                  </label>
            ...
            <button
              type="submit"
              className="w-full py-4 bg-gradient-to-r from-[#003580] to-[#0071C2] text-white font-bold rounded-xl hover:shadow-xl transition-all"
            >
          ...
          <p className="text-center text-sm text-[#64748B]">
            ...
            <Link to="/register" className="text-[#0071C2] font-semibold hover:underline">
