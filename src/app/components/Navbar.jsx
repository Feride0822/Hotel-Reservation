      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#003580] to-[#0071C2] flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  ...
                  {availableLanguages.map((lang) => (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-2.5 text-left hover:bg-[#F8FAFC] transition-colors ${
                        language === lang.code ? 'bg-[#F8FAFC] text-[#0071C2]' : 'text-[#0F172A]'
                      }`}
                    >
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pb-4 border-b border-[#E2E8F0]">
                <div className="text-xs font-medium text-gray-500 mb-2 px-4">{t('userDashboard.language')}</div>
                  ...
                  {availableLanguages.map((lang) => (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-left transition-colors ${
                        language === lang.code ? 'bg-[#F8FAFC] text-[#0071C2]' : 'text-[#0F172A] hover:bg-[#F8FAFC]'
                      }`}
                    >
                      <span className="text-xl">{lang.flag}</span>
                      <span className="font-medium">{lang.name}</span>
